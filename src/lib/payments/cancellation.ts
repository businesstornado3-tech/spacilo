 ...
 *
 * EarnRoom's commercial policy lives here, versioned, in exactly one
 ...
 * storage amount AND 100% of the EarnRoom service fee. Post-start
 ...
 * EarnRoom service fee is platform revenue and is never taken from the

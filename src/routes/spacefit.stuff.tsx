...
const description =
  "See how much storage your belongings really need. Scan your things with SpaceFit AI — no account needed to try it.";
    ...
    <MarketingLayout>
      <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
        ...
        <p className="mt-2 type-body text-muted-foreground">
          Photograph your belongings and SpaceFit AI will suggest what it sees. You correct the list
        ...
        <section className="mt-4 rounded-2xl border border-border bg-card p-5">
          ...
          <p className="mt-1 type-body-sm text-muted-foreground">
            SpaceFit AI proposes — you decide. Change quantities, remove anything wrong, add what it
            missed.
          </p>
                ...
                <li key={item.id} className="flex items-center gap-3 py-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="type-body-sm text-muted-foreground">
                      {item.source === "ai" ? "Suggested by SpaceFit AI" : "Added by you"}

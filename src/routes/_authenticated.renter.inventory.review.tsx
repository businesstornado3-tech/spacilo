...
const title = "Review EarnRoom AI results — " + brand.name;
const description = "Check what EarnRoom AI spotted in your photos before adding it to My Stuff.";
          ...
          <EmptyState
            ...
            description={
              run?.status === "failed"
                ...
                : "Upload photos and run EarnRoom AI to see suggestions here."
            }
          />

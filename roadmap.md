...
- [ ] Diagnose Instagram OAuth, token, permissions, account eligibility, app access, and exact failed publishing stage without publishing
- [ ] Diagnose Facebook Page token, permissions, selection, eligibility, and exact previous failure without publishing
- [ ] Add Founder-only Meta diagnostics and truthful reconnect/approval actions
- [ ] Preserve and verify YouTube/Shorts, approval, autonomous-only quotas, unlimited generation, paid presets, and creative diversity

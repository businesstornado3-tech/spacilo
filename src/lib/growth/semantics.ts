...
const RULES: readonly Rule[] = [
  ...
  },
  {
    ...
    test: /\b(selling|sell my (house|home|flat)|viewings?|renovat|building work|refurb|decorating|clear(?:ing)? (my|the|parents'?|mum'?s|dad'?s) (house|home|flat)|probate|downsiz)\b/,

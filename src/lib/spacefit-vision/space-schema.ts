...
export const SPACE_SCAN_DISCLAIMER =
  "EarnRoom AI estimates from photos and can be wrong. Check every figure against the real space before you publish — nothing is saved to your listing until you confirm it.";
